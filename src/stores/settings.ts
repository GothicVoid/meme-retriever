...
export const useSettingsStore = defineStore("settings", () => {
  ...
  watch([defaultLimit, deleteOriginalFile, libraryPath, showDebugInfo, w1, w2, w3], () => {
  ...
  load();
  return { defaultLimit, deleteOriginalFile, libraryPath, showDebugInfo, w1, w2, w3, normalizedWeights };
});
